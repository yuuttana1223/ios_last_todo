...
class ListViewController: UIViewController {
    ...
    let realm = try! Realm()
    var todos = try! Realm().objects(Todo.self).sorted(byKeyPath: "deadline", ascending: false)
    var nowTodos = try! Realm().objects(Todo.self).sorted(byKeyPath: "deadline", ascending: false)
